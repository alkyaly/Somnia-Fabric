...
public class WakeTimeSelectScreen extends Screen
{
	...
	public void render(PoseStack pose, int mouseX, int mouseY, float partialTicks) {
		...
		super.render(pose, mouseX, mouseY, partialTicks);
		drawCenteredString(pose, this.font, "Sleep until...?", this.width / 2, this.height / 2 - 5, 16777215);
		if (this.minecraft != null && this.minecraft.player != null) drawCenteredString(pose, this.font, SomniaUtil.timeStringForWorldTime(this.minecraft.player.level.getDayTime()), this.width/2, this.height/2 - 66, 16777215);
	}
